...
export const GET: APIRoute = () => {
  ...
  const payload = {
    ...
    name: 'context-atoms',
    description: 'Context primitives for AI runtimes — situational frames, environment descriptors, conversation scopes, working-memory shapes, attention budgets.',
    site: 'https://context-atoms.com',
    ...
    catalog: {
      ...
      exports_url: 'https://context-atoms.com/exports/catalog.json',
    },
    endpoints: {
      atoms: 'https://context-atoms.com/atoms/',
      exports: 'https://context-atoms.com/exports/catalog.json',
      ai_discovery: 'https://context-atoms.com/ai/index.json',
    },
    workflow: [
